...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/recipients/master/_listings/server-density/apis.md
...
- name: Alerts API - Alerts Recipients
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/recipients/master/_listings/server-density/alertsrecipients-get-openapi.md
- name: Alerts API - Alerts Recipients
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/recipients/master/_listings/server-density/alertsrecipientsrecipient-id-get-openapi.md
- name: Alerts API - Alerts Recipient
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/recipients/master/_listings/server-density/alertsrecipient-post-openapi.md
- name: Alerts API - Alerts Recipient
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/recipients/master/_listings/server-density/alertsrecipientrecipient-id-put-openapi.md
- name: Alerts API - Alerts Recipients
  x-api-slug: alertsrecipients-get
  description: Gets a list of all alert recipient's targets that are visible to you
    as a customer.
